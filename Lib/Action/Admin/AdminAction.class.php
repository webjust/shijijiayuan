...
abstract class AdminAction extends GyfxAction {
            ...
            if (!$rbac->AccessDecision()) {
                ...
                if (C('RBAC_ERROR_PAGE')) {
                    ...
                    if($this->isAjax()){//ajax 请求没有权限
						...
						switch($admin_url){
							case '/Admin/System/pageList':
							$admin_url = '/Admin/System/index';
							break;	
							case '/Admin/Role/pageList':
							$admin_url = '/Admin/Role/index';
							break;								
							default:
							break;
						}
        ...
        if (!session(C('USER_AUTH_KEY'))) {
			...
			if(empty($SESSION_TYPE)){
				...
				if(!empty($session_uid)){
					$ary_admin = getCache($session_uid);
					if(!empty($ary_admin) && !empty($ary_admin['u_name'])){
						$_SESSION['admin_name']       = $ary_admin['u_name'];
						$_SESSION['login_count']      = $ary_admin['u_login_count'];
					}   
				}		
			}
    ...
    private function getTop() {
        ...
        $tops[1] = array('name' => L('NAV1_2'), 'url' => U('Admin/Notice/pageList') ,'sn' => 'NAV1_2','type'=>'1,2,3'); //官网运营
        $tops[2] = array('name' => L('NAV1_3'), 'url' => U('Admin/Products/pageList') ,'sn' => 'NAV1_3','type'=>'1,2,3'); //商品管理
        $tops[3] = array('name' => L('NAV1_5'), 'url' => U('Admin/Orders/pageList') ,'sn' => 'NAV1_4','type'=>'1,2,3'); //订单管理
        $tops[4] = array('name' => L('NAV1_4'), 'url' => U('Admin/Promotions/pageProList') ,'sn' => 'NAV1_5','type'=>'1,2,3'); //价格促销
        $tops[5] = array('name' => L('NAV1_6'), 'url' => U('Admin/Members/pageList') ,'sn' => 'NAV1_6','type'=>'1,2,3'); //渠道管控
        $tops[6] = array('name' => L('NAV1_7'), 'url' => U('Admin/BalanceInfo/pageList') ,'sn' => 'NAV1_7','type'=>'1,2,3'); //财务管理
    ...
    private function getMenus() {
        ...
        $menus[1][0][20] = array('name' => '关键词屏蔽', 'url' => U('Admin/Index/word'));
        $menus[1][0][30] = array('name' => '前台日志', 'url' => U('Admin/Index/userlogs'));
...
//        $menus[2][3][90] = array('name' => L('MENU1_3_90'), 'url' => U('Admin/Home/pageCustomAdd')); //新增自定义页面
		...
		$menus[2][3][130] = array('name' => '广告图片管理', 'url' => U('Admin/Home/pageTopAd'),'type'=>'1,2,3'); //首页头部广告图片管理
        $menus[2][3][140] = array('name' => '会员中心皮肤管理', 'url' => U('Admin/Home/pageUcenterSkin'),'type'=>'1,2,3'); //会员中心皮肤管理
        $menus[2][3][150] = array('name' => 'APP图片管理', 'url' => U('Admin/Home/appPicManage'),'type'=>'1,2,3'); //APP图片管理
        $menus[2][3][160] = array('name' => '模板回收站', 'url' => U('Admin/Home/pageBinTpl'),'type'=>'1,2,3'); //回收站
        ...
        $menus[2][10][0] = array('name' => L('MENU1_10'), 'url' => U('Admin/Nav/index'),'type'=>'1,2,3');
        $menus[2][10][10] = array('name' => L('MENU1_10_10'), 'url' => U('Admin/Ad/pageList'),'type'=>'1,2,3'); //自定义广告列表
        $menus[2][10][20] = array('name' => L('MENU1_10_20'), 'url' => U('Admin/Ad/pageAdd'),'type'=>'1,2,3'); //新增自定义广告
       ...
       // $menus[3][0][60] = array('name' => '新增库存调整单', 'url' => U('Admin/Stock/pageAdd'),'type'=>'1,2,3'); //新增库存调整单
		$menus[3][0][55] = array('name' => '商品设置', 'url' => U('Admin/Goods/pageSet'),'type'=>'1,2,3'); //商品设置
...
//        $menus[4][1][50] = array('name' => '自定义退货/退款理由', 'url'=>U('Admin/RefundsProperty/returnReason'), 'type'=>'1,2,3');//自定义退货/退款理由
        $menus[4][1][50] = array('name' => '自定义退货/退款理由', 'url'=>U('Admin/RefundsProperty/returnReasonList'), 'type'=>'1,2,3');//自定义退货/退款理由
...
//        $menus[5][0][20] = array('name' => L('MENU4_0_20'), 'url' => U('Admin/Promotions/pageAdd'),'type'=>'1,2,3'); //新建促销活动
        ...
        $menus[5][1][10] = array('name' => L('MENU4_1_10'), 'url' => U('Admin/Coupon/pageList'),'type'=>'1,2,3'); //优惠券列表
        ...
        $menus[5][1][37] = array('name' => L('MENU4_1_37'), 'url' => U('Admin/Coupon/pageActivities'),'type'=>'1,2,3'); //新增优惠券活动功能
        $menus[5][1][39] = array('name' => L('MENU4_1_39'), 'url' => U('Admin/Coupon/pageActList'),'type'=>'1,2,3');  //优惠券活动列表
		$menus[5][1][70] = array('name' => L('MENU4_1_40'), 'url' => U('Admin/Coupon/pageSet'),'type'=>'1,2,3');//优惠券获取节点
		$menus[5][1][80] = array('name' => L('MENU4_1_50'), 'url' => U('Admin/Coupon/rulesSet'),'type'=>'1,2,3');//优惠券设置
        //团购活动
        ...
        //积分+金额兑换
        $menus[5][8][0] = array('name' => '积分兑换', 'url' => U('Admin/Integral/index'),'type'=>'1,2,3');
        $menus[5][8][10] = array('name' => '积分兑换列表', 'url' => U('Admin/Integral/pageList'),'type'=>'1,2,3');
        $menus[5][8][20] = array('name' => '新增积分兑换商品', 'url' => U('Admin/Integral/pageAdd'),'type'=>'1,2,3');
        $menus[5][8][30] = array('name' => '积分兑换分类', 'url' => U('Admin/Integral/pageCateList'),'type'=>'1,2,3');
        ...
        $menus[6][0][100] = array('name' => L('合伙人列表'), 'url' => U('Admin/Members/partnerList'),'type'=>'1,2,3'); //合伙人列表
...
//         $menus[6][3][10] = array('name' => L('MENU5_3_10'), 'url' => U('Admin//'),'type'=>'1,2,3'); //设置虚拟库存
        ...
        */
        ...
        $menus[7][4][10] = array('name' => L('MENU6_4_10'), 'url' => U('Admin/BalanceInfo/pageList'),'type'=>'1,2,3'); //结余款调整单列表
		...
		**/
		...
		$menus[8][1][15] = array('name' => L('七牛图片列表'), 'url' => U('Admin/Images/pageQnList'),'type'=>'1,2,3'); //七牛图片列表
        $menus[8][1][30] = array('name' => L('MENU7_1_30'), 'url' => U('Admin/Images/pageSet'),'type'=>'1,2,3'); //水印设置
		$menus[8][1][40] = array('name' => L('MENU7_1_40'), 'url' => U('Admin/TopOss/pageSet'),'type'=>'1,2,3'); //图片服务器设置
        ...
        **/
        $menus[8][7][0] = array('name' => L('MENU7_7'), 'url' => U('Admin/Api/index'),'type'=>'1,2,3'); //分销开放平台设置
        $menus[8][7][10] = array('name' => L('MENU7_7_10'), 'url' => U('Admin/Api/pageSet'),'type'=>'1,2,3'); //分销开放平台
        ...
        $menus[8][10][0] = array('name' => "CPS管理", 'url' => '#','type'=>'1,2,3');
        $menus[8][10][10] = array('name' => "CPS设置", 'url' => U('Admin/CostPerSale/pageSetting'),'type'=>'1,2,3'); //后台操作记录列表
        $menus[8][10][20] = array('name' => "CPS相关地址", 'url' => U('Admin/CostPerSale/stationInfo'),'type'=>'1,2,3'); //后台操作记录列表
	   // echo "<pre>";print_r($menus);exit;
        ...
        foreach($this->tops as $key_t=>$val_v){
			...
			$top_menus_area = D('Gyfx')->selectOneCache('menus',null, $top_where,'threeorder asc');
                ...
                if($key_t+1 == $key_menus_top){
                    foreach ($val_menus_top as $key_menus_second=>$val_menus_second){
                        foreach ($val_menus_second as $kt=>$kv){
							...
							$second_menus_area = D('Gyfx')->selectOneCache('menus',null, array('sn'=>$sn),'threeorder asc');
                            ...
                            if($kt == 0 && empty($second_menus_area)){
                                ...
                                if($kt != 0){
									...
									$last_menus = D('Gyfx')->selectOneCache('menus',null, array('sn'=>$last_menus_sn),'threeorder asc');
									if(isset($last_menus['id'])){
										...
										$third_menus = D('Gyfx')->selectOneCache('menus',null, $second_where,'threeorder asc');
       ...
       //echo "<pre>";print_r($ary_menu);exit;
        if(!empty($ary_menu) && is_array($ary_menu)){
            foreach($ary_menu as $keymu=>$valmu){
				...
				$arr_menu = D('Gyfx')->selectAllCache('menus',null, array('group'=>'Admin','mstatus'=>'1','fid'=>$valmu['id']),'threeorder asc');
                ...
                if(!empty($arr_menu)){
                    foreach($arr_menu as $kymu=>$vlmu){
                        ...
                        if(in_array(C('CUSTOMER_TYPE'),$ary_types)){
							...
							$arr_menus = D('Gyfx')->selectAllCache('menus',null, array('group'=>'Admin','mstatus'=>'1','fid'=>$vlmu['id']),'threeorder asc');
                            if(!empty($arr_menus)){
    ...
    public function saveMenus($data){
        ...
        if(!empty($data) && is_array($data)){
            foreach($data as $keym=>$valm){
				...
				$ary_nav = D('Gyfx')->selectOneCache('menus',$ary_field=null, array('sn'=>'NAV1_'.($keym-1),'mstatus'=>'1','group'=>'Admin'), $ary_order=null,$time=null);
                $ary_data = array();
...
//                echo $ary_result;
				...
				$ary_nav = D('Gyfx')->selectOneCache('menus',$ary_field=null, array('sn'=>'MENU'.($keym-1).'_'.($kym),'group'=>'Admin'));
                            $arr_data = array();
...
//                            echo "------------------------此处分割-----------------------";
                            if(FALSE !== $ary_res){
								...
								$nav = D('Gyfx')->selectOneCache('menus',$ary_field=null, array('sn'=>'MENU'.($keym-1).'_'.($kym).'_'.$km,'group'=>'Admin'));
                                    $data = array();
                                    $data['name'] = $vm['name'];
                                    $data['group'] = "Admin";

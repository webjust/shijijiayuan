...
//    			';   			
           ...
           $this->cate_html .="
            <td><a href='".U("Admin/GoodsCategory/addCategory?gcid=$ary_cate[cid]")."'>".$ary_cate[cid]."添加子分类</a></td>
            </tr>
           ";      
           if(!empty($ary_cate['sub'])){
           	$i++;
    ...
    public function doAdd(){
        ...
        $array_insert_data['gc_title'] = (isset($_POST['gc_title']) && "" != $_POST['gc_title'])?$_POST['gc_title']:"";
        $array_insert_data['gc_keyword'] = (isset($_POST['gc_keyword']) && "" != $_POST['gc_keyword'])?$_POST['gc_keyword']:"";
        //新增的两个属性NcadCode,HSCode
        $array_insert_data['NcadCode'] = (isset($_POST['NcadCode']) && "" != $_POST['NcadCode'])?$_POST['NcadCode']:"";
        $array_insert_data['HSCode'] = (isset($_POST['HSCode']) && "" != $_POST['HSCode'])?$_POST['HSCode']:"";
    ...
    public function doEdit(){
        ...
        $array_modify_data['gc_title'] = (isset($_POST['gc_title']) && "" != $_POST['gc_title'])?$_POST['gc_title']:"";
        $array_modify_data['gc_keyword'] = (isset($_POST['gc_keyword']) && "" != $_POST['gc_keyword'])?$_POST['gc_keyword']:"";

        $array_modify_data['NcadCode'] = (isset($_POST['NcadCode']) && "" != $_POST['NcadCode'])?$_POST['NcadCode']:"";
        $array_modify_data['HSCode'] = (isset($_POST['HSCode']) && "" != $_POST['HSCode'])?$_POST['HSCode']:"";

	...
	$("#search_submit_button").click(function(){
	    ...
	    search_key=search_key.replace(/%0d%0a/,'');
	    var __search_base_url="/Home/Hisense?keyword="+search_key;
	...
	$.extend(z,{
		initStat : function(){
			...
			$(".btn_fliter_expan").toggle(function(){
				...
				$(this).siblings(".filter_attrs").addClass("expand")
				$(this).addClass("expand")

			},function(){
				$(this).siblings(".filter_attrs").removeClass("expand")
		    ...
		    $(".big_ul .brand-item").hover(function(){
				...
				$('.big_ul .word').html($(this).attr("data-word"));
		    })

...
(function($) {
	$.fn.jqzoom = function(G) {
		...
		return this.each(function() {
			...
			var f = $(a).attr('rel');
			var g = $("img", this);console.log("line:44,g=",g[0]);
			var j = g.attr('title');
			g.removeAttr('title');
			...
			function Smallimage(c) {console.log("line:151:",c[0].src);
				this.node = c[0];
				this.loadimage = function() { //console.log("line:153:",c[0].src);
			...
			function Lens() {
				...
				this.loadlens = function() { $.log(H.zoomType);
					switch (H.zoomType) {
					case 'reverse':
						this.image = new Image();
						this.image.src = k.node.src; $.log(this.image);
			...
			function Largeimage(a) { console.log("line 468,a=",a);
				this.url = a;
				this.node = new Image();
			...
			function Stage() { 
				...
				var b = jQuery(g).offset().top; console.log("line 533,a,b=",a,b);
				this.node = document.createElement("div");

	...
	a.fn.slide = function(b) {
		return a.fn.slide.defaults = {
			...
			var s = function(a) {
				...
				fb = function() {
					clearInterval(H), Q ? bb() : s(), i.removeClass("pauseState")
				},
				gb = function() {
					clearInterval(H), i.addClass("pauseState")
				};
			if (v ? Q ? (w ? p-- : p++, bb(), z && l.hover(gb, fb)) : (s(), z && d.hover(gb, fb)) : (Q && (w ? p-- : p++), i.addClass("pauseState")), i.click(function() {
				...
				if (g.mousedown(db), f.mousedown(eb), y) {
					var ba, ib = function() {
						...
						jb = function() {
							clearTimeout(ba), clearInterval(H), bb()
						};

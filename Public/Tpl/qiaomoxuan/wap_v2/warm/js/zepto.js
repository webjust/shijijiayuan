...
var Zepto = function () {
  ...
  function h(t) {
    var e,
    n;
    return k[t] || (e = Z.createElement(t), Z.body.appendChild(e), n = getComputedStyle(e, '').getPropertyValue('display'), e.parentNode.removeChild(e), 'none' == n && (n = 'block'), k[t] = n),
    k[t]
  }
  function p(t) {
  ...
  function d(t, e, n) {
    for (j in e) n && (o(e[j]) || G(e[j])) ? (o(e[j]) && !o(t[j]) && (t[j] = {
    }), G(e[j]) && !G(t[j]) && (t[j] = [
    ]), d(t[j], e[j], n))  : e[j] !== b && (t[j] = e[j])
  }
  function m(t, e) {
  ...
  U.fragment = function (t, e, n) {
    ...
    i,
    a;
    return $.test(t) && (r = E(Z.createElement(RegExp.$1))),
    r || (t.replace && (t = t.replace(L, '<$1></$2>')), e === b && (e = D.test(t) && RegExp.$1), e in H || (e = '*'), a = H[e], a.innerHTML = '' + t, r = E.each(S.call(a.childNodes), function () {
      a.removeChild(this)
    })),
  ...
  U.init = function (t, n) {
    var r;
    if (!t) return U.Z();
    if ('string' == typeof t) if (t = t.trim(), '<' == t[0] && D.test(t)) r = U.fragment(t, RegExp.$1, n),
    t = null;
     else {
      if (n !== b) return E(n).find(t);
      r = U.qsa(Z, t)
    } else {
      if (e(t)) return E(Z).ready(t);
      if (U.isZ(t)) return t;
      if (G(t)) r = s(t);
       else if (i(t)) r = [
        t
      ...
      t = null;
       else if (D.test(t)) r = U.fragment(t.trim(), RegExp.$1, n),
      t = null;
       else {
        if (n !== b) return E(n).find(t);
        r = U.qsa(Z, t)
  ...
  U.qsa = function (t, e) {
    ...
    a = i || o ? e.slice(1)  : e,
    s = I.test(a);
    return r(t) && s && i ? (n = t.getElementById(a)) ? [
      n
    ] : [
    ] : 1 !== t.nodeType && 9 !== t.nodeType ? [
    ] : S.call(s && !i ? o ? t.getElementsByClassName(a)  : t.getElementsByTagName(e)  : t.querySelectorAll(e))
  },
  E.contains = Z.documentElement.contains ? function (t, e) {
  ...
  E.fn = {
    ...
    ready: function (t) {
      return V.test(Z.readyState) && Z.body ? t(E)  : Z.addEventListener('DOMContentLoaded', function () {
        t(E)
      }, !1),
      this
    },
    ...
    not: function (t) {
      ...
      if (e(t) && t.call !== b) this.each(function (e) {
        ...
        var r = 'string' == typeof t ? this.filter(t)  : a(t) && e(t.item) ? S.call(t)  : E(t);
    ...
    parents: function (t) {
      for (var e = [
      ], n = this; n.length > 0; ) n = E.map(n, function (t) {
    ...
    offsetParent: function () {
      return this.map(function () {
        for (var t = this.offsetParent || Z.body; t && !F.test(t.nodeName) && 'static' == E(t).css('position'); ) t = t.offsetParent;
        return t
      })
    }
  },
  ...
  R.forEach(function (e, n) {
    ...
    E.fn[e] = function () {
      ...
      return o.length < 1 ? this : this.each(function (t, e) {
        ...
        var s = E.contains(Z.documentElement, i);
    ...
    return e && !m(e) ? (t.each(e, function (t, e) {
      ...
      n && (c = function (e) {
        ...
        return o && o !== h ? (r = t.extend(f(e), {
          ...
          r
        ].concat(p.call(arguments, 1))))  : void 0
      }),
      s(h, e, i, r, n, c || a)
    }))
  },
...
window.Zepto && function (t) {
  ...
  function o(t, e) {
    var r = e.context;
    return e.beforeSend.call(r, t, e) === !1 || n(e, r, 'ajaxBeforeSend', [
      t,
      e
    ]) === !1 ? !1 : void n(e, r, 'ajaxSend', [
      t,
      e
    ])
  }
  ...
  t.ajaxJSONP = function (e, n) {
    ...
    t(f).on('load error', function (o, u) {
      clearTimeout(i),
      t(f).off().remove(),
    ...
    if (E.setRequestHeader = b, E.onreadystatechange = function () {
      if (4 == E.readyState) {
        ...
        if (E.status >= 200 && E.status < 300 || 304 == E.status || 0 == E.status && 'file:' == j) {
          ...
          n ? s(n, 'parsererror', E, i, u)  : a(e, E, i, u)
        } else s(E.statusText || null, E.status ? 'error' : 'abort', E, i, u)
      }
...
window.Zepto && function (t) {
  t.Callbacks = function (e) {
    ...
    f = function (t) {
      ...
      i = !1,
      u && (c ? c.length && f(c.shift())  : n ? u.length = 0 : l.disable())
    },
    l = {
      add: function () {
        if (u) {
...
window.Zepto && function (t) {
  ...
  t.when = function (r) {
    ...
    if (u > 1) for (i = new Array(u), o = new Array(u), a = new Array(u); u > c; ++c) s[c] && t.isFunction(s[c].promise) ? s[c].promise().done(h(c, a, s)).fail(l.reject).progress(h(c, o, i))  : --f;
    return f || l.resolveWith(a, s),
    l.promise()
  },
  t.Deferred = e
}(Zepto),
...
!function (t) {
  ...
  l = function (t, e) {
    ...
    return t = o[1],
    u && (u = n(u, e), r = a(u)),
    u ? t = r && r.normalize ? r.normalize(t, i(e))  : n(t, e)  : (t = n(t, e), o = s(t), u = o[0], t = o[1], u && (r = a(u))),
    {
      f: u ? u + '!' + t : t,
      n: t,
      pr: u,
  ...
  c = function (n, i, s, u) {
    ...
    if (u = u || n, 'undefined' === b || 'function' === b) {
      for (i = !i.length && s.length ? [
        ...
        'exports',
        'module'
      ] : i, y = 0; y < i.length; y += 1) if (g = l(i[y], u), f = g.f, 'require' === f) x[y] = h.require(n);
      ...
      w = !0;
        ...
        g.p.load(g.n, r(u, !0), o(f), {
        }),
        x[y] = p[f]
      }
      m = s ? s.apply(p[n], x)  : void 0,

...
class MultiComplexField extends Field{
    ...
    public function toParamElement($fieldElem = null){
        ...
        if($this->_complexValues){
            foreach($this->_complexValues->getComplexValues() as $key=>$complexValue){
				$complexValue = unserialize($complexValue);
                $complexElem = $fieldElem->addChild("complex-values");
				/*zhangjiasuo modify by 2015-03-14 start*/
				if(is_object($complexValue)){
				...
				/*zhangjiasuo modify by 2015-03-14 end*/
